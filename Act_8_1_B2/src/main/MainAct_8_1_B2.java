 ...
 * Todo esto lo hará a partir de la clase ArrayOrdenado.
 * 
...
public class MainAct_8_1_B2 {
	...
	public static void main(String[] args) {
		...
		ArrayOrdenado array = new ArrayOrdenado (tam);
		
		do {
			System.out.println("MENU (ARRAY ORDENADO):");
